...
export class MeditationEngine {
    ...
    calculateProgress() {
        ...
        // ⚡ BOLT OPTIMIZATION: Use a single O(n) loop and Date.now() for efficient duration calculation
        // reducing complexity from O(2pass) to O(1pass) and avoiding redundant new Date() allocations.
