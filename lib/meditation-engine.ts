...
export class MeditationEngine {
    ...
    /**
     * ⚡ BOLT OPTIMIZATION: O(1pass) progress calculation
     * Replaced multiple reduce passes with a single loop and eliminated
     * per-iteration object allocations by using Date.now().
     */
    calculateProgress() {
        let totalDuration = 0;
