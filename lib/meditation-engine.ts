...
export class MeditationEngine {
    ...
    calculateProgress() {
        // ⚡ BOLT OPTIMIZATION: Combine loops to reduce algorithmic complexity from O(2n) to O(n)
        // and use Date.now() instead of repeatedly instantiating new Date() objects.
        let totalDuration = 0;
