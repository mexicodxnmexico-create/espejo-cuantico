    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <label htmlFor="frecuencia" style={{ fontSize: "1rem", marginBottom: "1rem", color: "#333", display: "block", fontWeight: "bold" }}>
        ...
        <div style={{
          ...
          <label htmlFor="geometria" style={{ fontSize: "1rem", marginBottom: "1rem", color: "#333", display: "block", fontWeight: "bold" }}>
            Geometría Sagrada
          </label>
          <select
            id="geometria"
        ...
        <div style={{
          ...
          <label htmlFor="duracion" style={{ fontSize: "1rem", marginBottom: "1rem", color: "#333", display: "block", fontWeight: "bold" }}>
            Duración (minutos)
          </label>
          <input
            id="duracion"
