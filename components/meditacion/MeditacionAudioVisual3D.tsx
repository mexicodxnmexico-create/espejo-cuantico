    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <label htmlFor="frecuencia-solfeggio" style={{ display: "block", fontWeight: "bold", fontSize: "1rem", marginBottom: "1rem", color: "#333" }}>
        ...
        <div style={{
          ...
          <label htmlFor="geometria-sagrada" style={{ display: "block", fontWeight: "bold", fontSize: "1rem", marginBottom: "1rem", color: "#333" }}>
            Geometría Sagrada
          </label>
          <select
        ...
        <div style={{
          ...
          <label htmlFor="duracion-minutos" style={{ display: "block", fontWeight: "bold", fontSize: "1rem", marginBottom: "1rem", color: "#333" }}>
            Duración (minutos)
          </label>
          <input
            id="duracion-minutos"
