...
const CONTAINER_STYLE: CSSProperties = { marginTop: "3rem", padding: "1.5rem", borderRadius: "12px", background: "linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)", textAlign: "center" };
const HEADING_STYLE: CSSProperties = { margin: "0 0 0.5rem 0", textTransform: "uppercase", fontSize: "0.75rem", color: "#666" };
const MESSAGE_STYLE: CSSProperties = { margin: 0, fontWeight: "500", color: "#333" };
...
export const PersonalInsight = memo(function PersonalInsight({ reflectionCount }: { reflectionCount: number }) {
  ...
  return (
    <div style={CONTAINER_STYLE}>
      <h4 style={HEADING_STYLE}>Insight Personal</h4>
