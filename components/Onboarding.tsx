...
// ⚡ BOLT OPTIMIZATION: Extract static configuration array to module level
// Prevents redundant object creation and garbage collection overhead on every render.
