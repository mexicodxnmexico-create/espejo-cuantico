...
// ⚡ BOLT OPTIMIZATION: Extract static data to top-level constants
// This prevents redundant object creation and garbage collection overhead on every render.
...
// This ensures referential stability and reduces memory allocation during the render cycle.
