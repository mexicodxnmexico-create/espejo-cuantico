...
export const GeometriaSagrada3D = memo(function GeometriaSagrada3D({ frecuencia, activo, tipo }: GeometriaSagrada3DProps) {
  ...
  // ⚡ BOLT: Internalize intensity state to bypass React re-renders every 2 seconds
  ...
  useFrame((state, delta) => {
    ...
    // ⚡ BOLT: Move intensity noise logic from React state to useFrame
    // This removes one re-render every 2 seconds for the whole 3D scene.
