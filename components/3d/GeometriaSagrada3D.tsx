...
export function GeometriaSagrada3D({ frecuencia, activo = false, tipo }: GeometriaSagrada3DProps) {
  ...
  useFrame((state, delta) => {
    ...
    // ⚡ BOLT: Actualizar intensidad independientemente de re-renders
