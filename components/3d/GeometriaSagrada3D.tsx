...
export const GeometriaSagrada3D = memo(function GeometriaSagrada3D({ frecuencia, activo, tipo }: GeometriaSagrada3DProps) {
  ...
  useFrame((state, delta) => {
    ...
    // ⚡ BOLT: Throttled intensity update (every 2s) via refs to avoid React re-renders
    ...
    // Direct material property mutation (O(1) vs React reconciliation)
    ...
    // Pulsación basada en intensidad - Direct transform mutation
    const escala = 1 + Math.sin(t * 2) * (intensidad / 200);
