...
export default function Home() {
  ...
  // ⚡ BOLT OPTIMIZATION: Memoize reversed history to avoid re-sorting on every render
  const reversedHistory = useMemo(() => state.history.slice().reverse(), [state.history]);
    ...
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 1rem" }}>
      ...
      <main style={{ padding: "4rem 0" }}>
        ...
        <section>
          ...
          <div style={{ backgroundColor: "#fafafa", padding: "1.5rem", borderRadius: "12px", border: "1px solid #eaeaea", height: "200px", overflowY: "auto", fontFamily: "monospace", fontSize: "0.9rem" }}>
            {reversedHistory.map((entry, i) => (
              <div key={i} style={{ marginBottom: "0.5rem", borderBottom: "1px solid #eee", paddingBottom: "0.5rem", color: i === 0 ? "#000" : "#999" }}>
                {i === 0 ? "> " : "  "} {entry}
              </div>
            ))}
          </div>
