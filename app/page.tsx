        ...
        <div style={GRID_STYLE}>
          <div style={CARD_STYLE}>
            ...
            <button
              ...
              title={state.phase === "COLLAPSED" ? "Acción no disponible: el sistema ha colapsado" : "Observar el sistema"}
            >
              Observar
            </button>
          </div>
          ...
          <div style={CARD_STYLE}>
            ...
            <button
              ...
              title={state.phase === "COLLAPSED" ? "Acción no disponible: el sistema ha colapsado" : "Reflejar estado"}
            >
              Reflejar
            </button>
          </div>
