...
const ENTROPY_STYLE: CSSProperties = { fontSize: "3rem", fontWeight: "bold", margin: "0.5rem 0" };

// ⚡ BOLT OPTIMIZATION: Memoized HistoryItem component
// Prevents re-rendering of existing history items when a new one is added.
// Uses static module-level constants to avoid object creation during render.
